...
<html lang = "eng">
	...
	<body style = "background-color:#d3d3d3;">
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/sb.png" width = "50px" height = "50px" />
					<h4 class = "navbar-text navbar-right">S.B. JAIN Library Management System</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				<div class = "container-fluid">
					<img src = "images/p.jpg" width = "50px" height = "50px"/>
					<br />
					<br />
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">copyright &copy;2021 by Pankaj Bankar016</label>
			</div>
		</nav>
	</body>
