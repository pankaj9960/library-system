		...
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/sb.png" width = "80px" height = "80px" />
					<h1 class = "navbar-text navbar-right">S.B. JAIN Library Management System</h1>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				<div class = "container-fluid">
					<img src = "images/p.jpg" width = "100px" height = "100px"/>
					<br />
					<br />
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<img src = "images/library.jpg" height = "500px" width = "110%" />
			</div>
		</div>
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">copyright &copy;2021 by Pankaj Bankar</label>
			</div>
		</nav>
	</body>
